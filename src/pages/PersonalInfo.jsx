...
const inputClass = "w-full h-14 bg-white/5 border border-white/10 rounded-2xl px-4 text-sm text-white font-semibold focus:outline-none focus:border-liftly-teal/50 focus:ring-1 focus:ring-liftly-teal/20 transition-all";
const selectClass = "w-full h-14 bg-[#0D1526] border border-white/10 rounded-2xl px-4 text-sm text-white font-semibold focus:outline-none focus:border-liftly-teal/50 focus:ring-1 focus:ring-liftly-teal/20 transition-all appearance-none";
const labelClass = "text-[10px] font-black text-white/40 uppercase tracking-widest mb-1.5 block px-1";
  ...
  return (
    <div className="bg-[#040810] min-h-full flex flex-col animate-fade-in">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-4">
        ...
        {/* ─── Body Metrics ─── */}
        <SectionCard title="Body Metrics" icon={<Ruler size={18} />} iconBg="bg-emerald-500/15 text-emerald-400">
          <div className="flex gap-3">
            <div className="w-1/2">
              <label className={labelClass}>Weight (kg)</label>
              <div className="relative">
                <Weight size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
            ...
            <div className="w-1/2">
              ...
              <div className="relative">
                <Ruler size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
          ...
          <div className="mt-3">
            ...
            <div className="relative">
              <Heart size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
        ...
        {/* ─── Training Profile ─── */}
        <SectionCard title="Training Profile" icon={<Dumbbell size={18} />} iconBg="bg-orange-500/15 text-orange-400">
          <div className="flex gap-3">
            <div className="w-1/2">
          ...
          <div className="mt-3">
            ...
            <div className="relative">
              <TrendingUp size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
          ...
          <div className="mt-3">
            ...
            <div className="relative">
              <Target size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
          ...
          <div className="mt-3">
            ...
            <div className="relative">
              <Dumbbell size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-white/40" />
        ...
        {/* Save Button */}
        <button onClick={handleSave} disabled={saving} className="w-full h-14 bg-liftly-teal hover:bg-liftly-teal/80 text-liftly-navy font-black text-base rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-95 disabled:opacity-60 shadow-teal mt-6">
